...
annotate service.EmployeeHires with @(UI.LineItem #EmployeeRecords: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.StaffHires with @(UI.LineItem #StaffRecords: [
...
annotate service.WorkOrders_WN with @(UI.LineItem #WorkOrdersWN: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.WorkOrders_FG with @(UI.LineItem #WorkOrdersFG: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
// term 4 interface
annotate service.Terminations with @(UI.LineItem #Terminations: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.Credit_Rebill with @(UI.LineItem #Credit_Rebill: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.OtherBillables with @(UI.LineItem #OtherBillables: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.SowScWo with @(UI.LineItem #SowScWo: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.SowScInvoice with @(UI.LineItem #SowScInvoice: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.Fg_Invoices with @(UI.LineItem #FgTimeInvoices: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.Travel with @(UI.LineItem #Travel: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
...
annotate service.Drug_Background_Check with @(UI.LineItem #Drug_Background_Check: [
    {
        $Type                    : 'UI.DataField',
        Value                    : valid,
        Criticality              : criticality,
