/* checksum : 1bac1147b9f514556bfa62a14ef38f31 */
@cds.external : true
type CE_SALESORDER_0001.SAP__Message {
...
entity CE_SALESORDER_0001.SalesOrder {
  @Core.Immutable : true
  ...
  @Common.Label : 'Custom Sales Order Type ( OLD)'
  YY1_CustomSalesOrder_SDH : String(4) not null;
  @Common.Label : 'Alphanumeric Sales Order'
  YY1_AlphanumericSalesO_SDH : String(15) not null;
  @Common.Label : 'Ship To Party'
  YY1_ShipToParty_SDH : String(12) not null;
  SAP__Messages : many CE_SALESORDER_0001.SAP__Message not null;
  @Common.Composition : true
  _Item : Composition of many CE_SALESORDER_0001.SalesOrderItem {  };
  @Common.Composition : true
  _Partner : Composition of many CE_SALESORDER_0001.SalesOrderPartner {  };
  @Common.Composition : true
  _PricingElement : Composition of many CE_SALESORDER_0001.SalesOrderPricingElement {  };
  @Common.Composition : true
  _Text : Composition of many CE_SALESORDER_0001.SalesOrderText {  };
};
...
entity CE_SALESORDER_0001.SalesOrderItem {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Sales Order'
  @Common.Heading : 'SO'
  ...
  OvrlTrdCmplncLegalCtrlChkSts : String(1) not null;
  @Common.Label : 'Straight Time Markup'
  YY1_StrTimeMarkup_SD_SDI : String(10) not null;
  @Common.Label : 'Duplicate Week'
  YY1_DuplicateWeek_SD_SDI : String(2) not null;
  @Common.Label : 'WN Work Order'
  YY1_WNWorkOrder_SD_SDI : String(10) not null;
  @Common.Label : 'Invoice VAT txt'
  YY1_InvoiceVATtxt_SD_SDI : String(4) not null;
  @Common.Label : 'YY3_ACA_HRS_PRICE'
  @Common.QuickInfo : 'ACA Hours Price'
  YY1_ACA_HRS_PRICE_SDI : Decimal(15, 2) not null;
  @Common.Label : 'Custom URL'
  YY1_CustomURL_SDI : String(200) not null;
  @Common.Label : 'Supplier Invoice Number'
  YY1_SupplierInvoice_SD_SDI : String(15) not null;
  @Common.Label : 'Royality'
  YY1_Royality_SD_SDI : String(3) not null;
  @Common.Label : 'YY1_ACA_RG_ONLY'
  @Common.QuickInfo : 'Customer Condition Group 2'
  YY1_ACA_RG_ONLY_SDI : String(2) not null;
  @Common.Label : 'Purchasing Doc'
  YY1_PurchasingDoc_SD_SDI : String(10) not null;
  @Common.Label : 'Category Code'
  YY1_CategoryCode_SD_SDI : String(15) not null;
  @Common.Label : 'Legacy Purchase Order'
  YY1_LegacyPurchase_SD_SDI : String(10) not null;
  @Common.Label : 'ExtensionUUID1'
  YY1_ExtensionUUID1_SDI : String(40) not null;
  @Common.Label : 'YY2_ACA_HRS'
  @Common.QuickInfo : 'ACA Hours'
  YY1_ACA_HRS_SDI : Decimal(15, 2) not null;
  @Common.Label : 'Custom Billing Type ( OLD)'
  YY1_CustomBillingType_SDI : String(4) not null;
  @Common.Label : 'Commodity Code'
  YY1_CommodityCode_SD_SDI : String(15) not null;
  @Common.Label : 'EE SubGroup'
  YY1_EEGroup_SD_SDI : String(2) not null;
  @Common.Label : 'Over Time Markup'
  YY1_OverTimeMarkup_SD_SDI : String(10) not null;
  @Common.Label : 'Double Time Markup'
  YY1_DoubTimeMarkup_SD_SDI : String(10) not null;
  @Common.Label : 'ExtensionUUID2'
  YY1_ExtensionUUID2_SDI : String(40) not null;
  @Common.Label : 'WN Invoice'
  YY1_WNInvoice_SD_SDI : String(15) not null;
  @Common.Label : 'Week End'
  YY1_WeekEnd_SD_SDI : Date;
  @Common.Label : 'Cost Center'
  YY1_CostCenter_SD_SDI : String(15) not null;
  SAP__Messages : many CE_SALESORDER_0001.SAP__Message not null;
  @Common.Composition : true
  _ItemPartner : Composition of many CE_SALESORDER_0001.SalesOrderItemPartner {  };
  @Common.Composition : true
  _ItemPricingElement : Composition of many CE_SALESORDER_0001.SalesOrderItemPricingElement {  };
  @Common.Composition : true
  _ItemText : Composition of many CE_SALESORDER_0001.SalesOrderItemText {  };
  _SalesOrder : Association to one CE_SALESORDER_0001.SalesOrder {  };
  @Common.Composition : true
  _ScheduleLine : Composition of many CE_SALESORDER_0001.SalesOrderScheduleLine {  };
  _VariantConfiguration : Association to one CE_SALESORDER_0001.VariantConfiguration {  };
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
@Core.OptimisticConcurrency : [ '_SalesOrder/LastChangeDateTime' ]
entity CE_SALESORDER_0001.SalesOrderItemPartner {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Sales Order'
  @Common.Heading : 'SO'
  ...
  SAP__Messages : many CE_SALESORDER_0001.SAP__Message not null;
  _Item : Association to one CE_SALESORDER_0001.SalesOrderItem {  };
  _SalesOrder : Association to one CE_SALESORDER_0001.SalesOrder {  };
};
...
entity CE_SALESORDER_0001.SalesOrderItemPricingElement {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Sales Order'
  @Common.Heading : 'SO'
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
@Core.OptimisticConcurrency : [ '_SalesOrder/LastChangeDateTime' ]
entity CE_SALESORDER_0001.SalesOrderItemText {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Sales Order'
  @Common.Heading : 'SO'
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
@Core.OptimisticConcurrency : [ '_SalesOrder/LastChangeDateTime' ]
entity CE_SALESORDER_0001.SalesOrderPartner {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Sales Order'
  @Common.Heading : 'SO'
...
entity CE_SALESORDER_0001.SalesOrderPricingElement {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Sales Order'
  @Common.Heading : 'SO'
...
entity CE_SALESORDER_0001.SalesOrderScheduleLine {
  @Core.Computed : true
  @Common.IsUpperCase : true
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
@Core.OptimisticConcurrency : [ '_SalesOrder/LastChangeDateTime' ]
entity CE_SALESORDER_0001.SalesOrderText {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Sales Order'
  @Common.Heading : 'SO'
...
entity CE_SALESORDER_0001.VarConfignAssignedValue {
  @Core.Computed : true
  @Common.IsUpperCase : true
  ...
  _Characteristic : Association to one CE_SALESORDER_0001.VarConfignCharacteristic {  };
  _VariantConfiguration : Association to one CE_SALESORDER_0001.VariantConfiguration {  };
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity CE_SALESORDER_0001.VarConfignCharacteristic {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Object Key'
  @Common.Heading : 'Key of Referencing Object'
  ...
  @Common.Composition : true
  _AssignedValue : Composition of many CE_SALESORDER_0001.VarConfignAssignedValue {  };
  _Instance : Association to one CE_SALESORDER_0001.VariantConfigurationInstance {  };
  _VariantConfiguration : Association to one CE_SALESORDER_0001.VariantConfiguration {  };
};
...
@Capabilities.UpdateRestrictions.QueryOptions.SelectSupported : true
entity CE_SALESORDER_0001.VariantConfiguration {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Object Key'
  @Common.Heading : 'Key of Referencing Object'
  ...
  SAP__Messages : many CE_SALESORDER_0001.SAP__Message not null;
  @Common.Composition : true
  _Instance : Composition of many CE_SALESORDER_0001.VariantConfigurationInstance {  };
};
...
entity CE_SALESORDER_0001.VariantConfigurationInstance {
  @Core.Computed : true
  @Common.IsUpperCase : true
  @Common.Label : 'Object Key'
  @Common.Heading : 'Key of Referencing Object'
  ...
  @Common.Composition : true
  _Characteristic : Composition of many CE_SALESORDER_0001.VarConfignCharacteristic {  };
  _VariantConfiguration : Association to one CE_SALESORDER_0001.VariantConfiguration {  };
};
