...
import { Yy1EmployeeCustomerInfoSapUpsertParameters } from './operations';
...
export declare function yy1EmployeeCustomerInfoCds<
  BinaryT = string,
  BooleanT = boolean,
  ByteT = number,
  DecimalT = BigNumber,
...
>(
  ...
  >
>;
declare class Yy1EmployeeCustomerInfoCds<
...
> {
  ...
  get operations(): {
    yy1EmployeeCustomerInfoSapUpsert: (
      ...
      import('./Yy1_Employee_Customer_Info').Yy1_Employee_Customer_Info<DefaultDeSerializers>
    >;
  };
