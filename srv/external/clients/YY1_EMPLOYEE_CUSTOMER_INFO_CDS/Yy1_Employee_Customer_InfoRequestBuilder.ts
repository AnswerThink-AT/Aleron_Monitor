 ...
 */
export class Yy1_Employee_Customer_InfoRequestBuilder<
...
> extends RequestBuilder<Yy1_Employee_Customer_Info<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Employee_Customer_Info<T>, T> {
    return new GetAllRequestBuilder<Yy1_Employee_Customer_Info<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<Yy1_Employee_Customer_Info<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Employee_Customer_Info<T>, T>(
      this.entityApi,
      { SAP_UUID: sapUuid }
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<Yy1_Employee_Customer_Info<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<Yy1_Employee_Customer_Info<T>, T>(
      this.entityApi,
      sapUuidOrEntity instanceof Yy1_Employee_Customer_Info
        ? sapUuidOrEntity
