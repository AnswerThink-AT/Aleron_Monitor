 ...
 */
export class Yy1_Workforce_CdsRequestBuilder<
...
> extends RequestBuilder<Yy1_Workforce_Cds<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Workforce_Cds<T>, T> {
    return new GetAllRequestBuilder<Yy1_Workforce_Cds<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Workforce_Cds<T>, T>(this.entityApi, {
