 ...
 */
class SalesOrderItemRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(salesOrderOrEntity, salesOrderItem) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderItem_1.SalesOrderItem
            ? salesOrderOrEntity
            : {
