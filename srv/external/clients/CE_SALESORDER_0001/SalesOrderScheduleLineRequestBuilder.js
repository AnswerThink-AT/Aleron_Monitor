 ...
 */
class SalesOrderScheduleLineRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(salesOrderOrEntity, salesOrderItem, scheduleLine) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderScheduleLine_1.SalesOrderScheduleLine
            ? salesOrderOrEntity
            : {
