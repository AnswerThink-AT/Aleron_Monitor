...
class SalesOrderItemApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            ...
            VARIANT_CONFIGURATION: new odata_v4_1.OneToOneLink('_VariantConfiguration', this, linkedApis[5])
        };
        return this;
    }
    requestBuilder() {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                REFERENCE_SD_DOCUMENT_ITEM: fieldBuilder.buildEdmTypeField('ReferenceSDDocumentItem', 'Edm.String', false),
                /**
