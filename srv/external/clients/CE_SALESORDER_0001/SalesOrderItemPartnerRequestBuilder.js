 ...
 */
class SalesOrderItemPartnerRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(salesOrderOrEntity, salesOrderItem, partnerFunction) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderItemPartner_1.SalesOrderItemPartner
            ? salesOrderOrEntity
            : {
