...
> {
  ...
  get varConfignAssignedValueApi(): VarConfignAssignedValueApi<DeSerializersT> {
    const api = this.initApi(
      'varConfignAssignedValueApi',
      VarConfignAssignedValueApi
    );
    const linkedApis = [
      this.initApi('varConfignCharacteristicApi', VarConfignCharacteristicApi),
      this.initApi('variantConfigurationApi', VariantConfigurationApi)
    ];
    api._addNavigationProperties(linkedApis);
    return api;
  ...
  get varConfignCharacteristicApi(): VarConfignCharacteristicApi<DeSerializersT> {
    const api = this.initApi(
      'varConfignCharacteristicApi',
      VarConfignCharacteristicApi
    );
    const linkedApis = [
      this.initApi('varConfignAssignedValueApi', VarConfignAssignedValueApi),
      this.initApi(
        'variantConfigurationInstanceApi',
        VariantConfigurationInstanceApi
      ),
      this.initApi('variantConfigurationApi', VariantConfigurationApi)
    ];
