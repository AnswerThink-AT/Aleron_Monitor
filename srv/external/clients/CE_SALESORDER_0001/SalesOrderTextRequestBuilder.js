 ...
 */
class SalesOrderTextRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(salesOrderOrEntity, language, longTextId) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderText_1.SalesOrderText
            ? salesOrderOrEntity
            : {
