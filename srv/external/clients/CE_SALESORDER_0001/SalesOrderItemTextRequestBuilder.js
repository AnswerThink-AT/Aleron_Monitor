 ...
 */
class SalesOrderItemTextRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(salesOrderOrEntity, salesOrderItem, language, longTextId) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderItemText_1.SalesOrderItemText
            ? salesOrderOrEntity
            : {
