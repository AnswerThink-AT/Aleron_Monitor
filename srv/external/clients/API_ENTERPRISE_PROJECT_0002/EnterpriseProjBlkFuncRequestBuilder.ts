 ...
 */
export class EnterpriseProjBlkFuncRequestBuilder<
...
> extends RequestBuilder<EnterpriseProjBlkFunc<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<EnterpriseProjBlkFunc<T>, T> {
    return new GetAllRequestBuilder<EnterpriseProjBlkFunc<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<EnterpriseProjBlkFunc<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EnterpriseProjBlkFunc<T>, T>(
      this.entityApi,
  ...
  update(
    ...
    return new UpdateRequestBuilder<EnterpriseProjBlkFunc<T>, T>(
      this.entityApi,
      entity
    );
  }
