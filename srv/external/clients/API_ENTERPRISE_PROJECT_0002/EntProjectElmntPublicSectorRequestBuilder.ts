 ...
 */
export class EntProjectElmntPublicSectorRequestBuilder<
...
> extends RequestBuilder<EntProjectElmntPublicSector<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<EntProjectElmntPublicSector<T>, T> {
    return new GetAllRequestBuilder<EntProjectElmntPublicSector<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EntProjectElmntPublicSector<T>, T>(
      this.entityApi,
  ...
  update(
    ...
    return new UpdateRequestBuilder<EntProjectElmntPublicSector<T>, T>(
      this.entityApi,
      entity
    );
  }
