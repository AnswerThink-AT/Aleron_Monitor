...
export class EnterpriseProjectApi<
...
> implements EntityApi<EnterpriseProject<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      TO_ENTERPRISE_PROJECT_ELEMENT: new Link(
        'to_EnterpriseProjectElement',
        this,
        linkedApis[0]
      ),
      TO_ENTERPRISE_PROJECT_JVA: new OneToOneLink(
        'to_EnterpriseProjectJVA',
        this,
        linkedApis[1]
      ),
      TO_ENT_PROJ_BLK_FUNC: new OneToOneLink(
        'to_EntProjBlkFunc',
        this,
        linkedApis[2]
      ),
      TO_ENT_PROJECT_PUBLIC_SECTOR: new OneToOneLink(
        'to_EntProjectPublicSector',
        this,
        linkedApis[3]
      ),
      TO_ENT_PROJ_ROLE: new Link('to_EntProjRole', this, linkedApis[4]),
      TO_ENT_PROJ_TEAM_MEMBER: new Link(
  ...
  entityConstructor = EnterpriseProject;

  requestBuilder(): EnterpriseProjectRequestBuilder<DeSerializersT> {
    return new EnterpriseProjectRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EnterpriseProject<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CHANGE_ENT_PROJ_PROCG_STATUS_AC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        COPY_TO_ACTIVE_DOCUMENT_AC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVAILABILITY_CONTROL_IS_ACTIVE_FC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVAILABILITY_CONTROL_PROFILE_FC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENTERPRISE_PROJECT_TYPE_FC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENT_PROJ_IS_MULTI_SLS_ORD_ITMS_ENBLD_FC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        IS_BILLING_RELEVANT_FC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PRIORITY_CODE_FC: fieldBuilder.buildEdmTypeField(
          'PriorityCode_fc',
          'Edm.Byte',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_FC: fieldBuilder.buildEdmTypeField(
          'Project_fc',
          'Edm.Byte',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_CURRENCY_FC: fieldBuilder.buildEdmTypeField(
          'ProjectCurrency_fc',
          'Edm.Byte',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_DESCRIPTION_FC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_END_DATE_FC: fieldBuilder.buildEdmTypeField(
          'ProjectEndDate_fc',
          'Edm.Byte',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_PROFILE_CODE_FC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_START_DATE_FC: fieldBuilder.buildEdmTypeField(
          'ProjectStartDate_fc',
          'Edm.Byte',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TO_ENTERPRISE_PROJECT_ELEMENT_OC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TO_ENT_PROJ_BLK_FUNC_OC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TO_ENT_PROJ_ROLE_OC: fieldBuilder.buildEdmTypeField(
          'to_EntProjRole_oc',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TO_ENT_PROJ_TEAM_MEMBER_OC: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENTERPRISE_PROJECT_TYPE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_START_DATE: fieldBuilder.buildEdmTypeField(
          'ProjectStartDate',
          'Edm.DateTime',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_END_DATE: fieldBuilder.buildEdmTypeField(
          'ProjectEndDate',
          'Edm.DateTime',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUSTOMER_UUID: fieldBuilder.buildEdmTypeField(
          'CustomerUUID',
          'Edm.Guid',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENTERPRISE_PROJECT_SERVICE_ORG: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENT_PROJECT_IS_CONFIDENTIAL: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        RESTRICTED_TIME_POSTING: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_PROFILE_CODE: fieldBuilder.buildEdmTypeField(
          'ProjectProfileCode',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_CURRENCY: fieldBuilder.buildEdmTypeField(
          'ProjectCurrency',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVAILABILITY_CONTROL_PROFILE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVAILABILITY_CONTROL_IS_ACTIVE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        IS_BILLING_RELEVANT: fieldBuilder.buildEdmTypeField(
          'IsBillingRelevant',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJECT_LAST_CHANGED_DATE_TIME: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENT_PROJ_IS_MULTI_SLS_ORD_ITMS_ENBLD: fieldBuilder.buildEdmTypeField(
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', EnterpriseProject)
      };
    }
