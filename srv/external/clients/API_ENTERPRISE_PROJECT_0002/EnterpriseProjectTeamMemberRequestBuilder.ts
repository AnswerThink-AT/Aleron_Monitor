 ...
 */
export class EnterpriseProjectTeamMemberRequestBuilder<
...
> extends RequestBuilder<EnterpriseProjectTeamMember<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<EnterpriseProjectTeamMember<T>, T> {
    return new GetAllRequestBuilder<EnterpriseProjectTeamMember<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<EnterpriseProjectTeamMember<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EnterpriseProjectTeamMember<T>, T>(
      this.entityApi,
