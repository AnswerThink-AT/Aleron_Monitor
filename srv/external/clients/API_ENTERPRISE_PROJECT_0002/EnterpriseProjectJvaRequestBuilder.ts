 ...
 */
export class EnterpriseProjectJvaRequestBuilder<
...
> extends RequestBuilder<EnterpriseProjectJva<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<EnterpriseProjectJva<T>, T> {
    return new GetAllRequestBuilder<EnterpriseProjectJva<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EnterpriseProjectJva<T>, T>(
      this.entityApi,
  ...
  update(
    ...
    return new UpdateRequestBuilder<EnterpriseProjectJva<T>, T>(
      this.entityApi,
      entity
    );
  }
