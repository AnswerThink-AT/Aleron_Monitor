 ...
 */
export class EntProjElmntDlvbrlRequestBuilder<
...
> extends RequestBuilder<EntProjElmntDlvbrl<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<EntProjElmntDlvbrl<T>, T> {
    return new GetAllRequestBuilder<EntProjElmntDlvbrl<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EntProjElmntDlvbrl<T>, T>(
      this.entityApi,
  ...
  update(
    ...
    return new UpdateRequestBuilder<EntProjElmntDlvbrl<T>, T>(
      this.entityApi,
      entity
    );
  }
