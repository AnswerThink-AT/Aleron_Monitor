...
exports.EntProjectPublicSectorApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const EntProjectPublicSector_1 = require("./EntProjectPublicSector");
const EntProjectPublicSectorRequestBuilder_1 = require("./EntProjectPublicSectorRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class EntProjectPublicSectorApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = EntProjectPublicSector_1.EntProjectPublicSector;
    ...
    requestBuilder() {
        return new EntProjectPublicSectorRequestBuilder_1.EntProjectPublicSectorRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(EntProjectPublicSector_1.EntProjectPublicSector, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', EntProjectPublicSector_1.EntProjectPublicSector)
            };
        }
        return this._schema;
    }
}
exports.EntProjectPublicSectorApi = EntProjectPublicSectorApi;
//# sourceMappingURL=EntProjectPublicSectorApi.js.map