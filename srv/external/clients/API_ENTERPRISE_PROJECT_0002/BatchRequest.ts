...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultApiEnterpriseProject0002Path,
...
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteApiEnterpriseProject0002RequestBuilder<DeSerializersT>
    | Array<WriteApiEnterpriseProject0002RequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteApiEnterpriseProject0002RequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultApiEnterpriseProject0002Path =
