 ...
 */
export class EntProjElmntDlvbrlDistrRequestBuilder<
...
> extends RequestBuilder<EntProjElmntDlvbrlDistr<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<EntProjElmntDlvbrlDistr<T>, T> {
    return new GetAllRequestBuilder<EntProjElmntDlvbrlDistr<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EntProjElmntDlvbrlDistr<T>, T>(
      this.entityApi,
  ...
  update(
    ...
    return new UpdateRequestBuilder<EntProjElmntDlvbrlDistr<T>, T>(
      this.entityApi,
      entity
    );
  }
