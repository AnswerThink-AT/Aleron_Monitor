 ...
 */
export class EntProjElmntWorkItemRequestBuilder<
...
> extends RequestBuilder<EntProjElmntWorkItem<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<EntProjElmntWorkItem<T>, T> {
    return new GetAllRequestBuilder<EntProjElmntWorkItem<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EntProjElmntWorkItem<T>, T>(
      this.entityApi,
  ...
  update(
    ...
    return new UpdateRequestBuilder<EntProjElmntWorkItem<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    entProjElmntWorkItemUuidOrEntity: any
  ): DeleteRequestBuilder<EntProjElmntWorkItem<T>, T> {
    return new DeleteRequestBuilder<EntProjElmntWorkItem<T>, T>(
      this.entityApi,
      entProjElmntWorkItemUuidOrEntity instanceof EntProjElmntWorkItem
