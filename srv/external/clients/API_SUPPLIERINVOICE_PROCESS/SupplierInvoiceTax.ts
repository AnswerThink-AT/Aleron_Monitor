 ...
 */
export class SupplierInvoiceTax<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements SupplierInvoiceTaxType<T>
{
   ...
   */
  static override _entityName = 'A_SupplierInvoiceTax';
  /**
   ...
   * Maximum length: 6.
   */
  declare supplierInvoiceTaxCounter: DeserializedType<T, 'Edm.String'>;
  /**
   * Currency Key.
   * Maximum length: 5.
   * @nullable
   ...
   * @nullable
   */
  declare taxRateValidityStartDate?: DeserializedType<T, 'Edm.DateTime'> | null;
