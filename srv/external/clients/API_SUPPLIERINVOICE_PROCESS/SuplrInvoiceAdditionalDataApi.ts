...
export class SuplrInvoiceAdditionalDataApi<
    ...
    EntityApi<SuplrInvoiceAdditionalData<DeSerializersT>, DeSerializersT>
{
  ...
  entityConstructor = SuplrInvoiceAdditionalData;

  requestBuilder(): SuplrInvoiceAdditionalDataRequestBuilder<DeSerializersT> {
    return new SuplrInvoiceAdditionalDataRequestBuilder<DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INVOICING_PARTY_NAME_1: fieldBuilder.buildEdmTypeField(
          'InvoicingPartyName1',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INVOICING_PARTY_NAME_2: fieldBuilder.buildEdmTypeField(
          'InvoicingPartyName2',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INVOICING_PARTY_NAME_3: fieldBuilder.buildEdmTypeField(
          'InvoicingPartyName3',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INVOICING_PARTY_NAME_4: fieldBuilder.buildEdmTypeField(
          'InvoicingPartyName4',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        POST_OFFICE_BANK_ACCOUNT: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ONE_TME_ACCOUNT_IS_VAT_LIABLE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ONE_TME_ACCT_IS_EQUALIZATION_TX_SUBJ: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DATA_MEDIUM_EXCHANGE_INDICATOR: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        IS_ONE_TIME_ACCOUNT: fieldBuilder.buildEdmTypeField(
          'IsOneTimeAccount',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PAYMENT_RECIPIENT: fieldBuilder.buildEdmTypeField(
          'PaymentRecipient',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_TAX_TYPE: fieldBuilder.buildEdmTypeField(
          'AccountTaxType',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BANK_DETAIL_REFERENCE: fieldBuilder.buildEdmTypeField(
          'BankDetailReference',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        REPRESENTATIVE_NAME: fieldBuilder.buildEdmTypeField(
          'RepresentativeName',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BUSINESS_TYPE: fieldBuilder.buildEdmTypeField(
          'BusinessType',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INDUSTRY_TYPE: fieldBuilder.buildEdmTypeField(
          'IndustryType',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        FORM_OF_ADDRESS_NAME: fieldBuilder.buildEdmTypeField(
          'FormOfAddressName',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ONE_TIME_ACCT_CNTRY_SPECIFIC_REF_1: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ONE_TIME_BUSINESS_PARTNER_EMAIL: fieldBuilder.buildEdmTypeField(
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SuplrInvoiceAdditionalData)
      };
    }
