 ...
 */
export class SuplrInvcSeldSrvcEntrShtLeanRequestBuilder<
...
> extends RequestBuilder<SuplrInvcSeldSrvcEntrShtLean<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SuplrInvcSeldSrvcEntrShtLean<T>, T> {
    return new GetAllRequestBuilder<SuplrInvcSeldSrvcEntrShtLean<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SuplrInvcSeldSrvcEntrShtLean<T>, T>(
      this.entityApi,
      {
