 ...
 */
export declare class PostInvoiceExportParametersField<
...
export declare namespace PostInvoiceExportParameters {
  /**
   * Metadata information on all properties of the `PostInvoiceExportParameters` complex type.
   */
  const _propertyMetadata: PropertyMetadata<PostInvoiceExportParameters>[];
}
