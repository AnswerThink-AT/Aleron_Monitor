 ...
 */
export class SuplrInvcSeldPurgDocumentRequestBuilder<
...
> extends RequestBuilder<SuplrInvcSeldPurgDocument<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SuplrInvcSeldPurgDocument<T>, T> {
    return new GetAllRequestBuilder<SuplrInvcSeldPurgDocument<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SuplrInvcSeldPurgDocument<T>, T>(
      this.entityApi,
      {
