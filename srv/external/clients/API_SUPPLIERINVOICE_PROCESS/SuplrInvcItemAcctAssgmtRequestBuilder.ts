 ...
 */
export class SuplrInvcItemAcctAssgmtRequestBuilder<
...
> extends RequestBuilder<SuplrInvcItemAcctAssgmt<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SuplrInvcItemAcctAssgmt<T>, T> {
    return new GetAllRequestBuilder<SuplrInvcItemAcctAssgmt<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SuplrInvcItemAcctAssgmt<T>, T>(
      this.entityApi,
      {
