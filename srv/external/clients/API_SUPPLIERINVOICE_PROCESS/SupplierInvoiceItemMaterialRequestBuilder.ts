 ...
 */
export class SupplierInvoiceItemMaterialRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<SupplierInvoiceItemMaterial<T>, T> {
  /**
   ...
   */
  getAll(): GetAllRequestBuilder<SupplierInvoiceItemMaterial<T>, T> {
    return new GetAllRequestBuilder<SupplierInvoiceItemMaterial<T>, T>(
      this.entityApi
    );
  }
  ...
  ): GetByKeyRequestBuilder<SupplierInvoiceItemMaterial<T>, T> {
    return new GetByKeyRequestBuilder<SupplierInvoiceItemMaterial<T>, T>(
      this.entityApi,
      {
