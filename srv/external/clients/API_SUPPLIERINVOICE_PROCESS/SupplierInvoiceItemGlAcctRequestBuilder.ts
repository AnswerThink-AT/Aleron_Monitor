 ...
 */
export class SupplierInvoiceItemGlAcctRequestBuilder<
...
> extends RequestBuilder<SupplierInvoiceItemGlAcct<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SupplierInvoiceItemGlAcct<T>, T> {
    return new GetAllRequestBuilder<SupplierInvoiceItemGlAcct<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SupplierInvoiceItemGlAcct<T>, T>(
      this.entityApi,
      {
