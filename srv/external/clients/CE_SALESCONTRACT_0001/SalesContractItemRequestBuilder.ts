 ...
 */
export class SalesContractItemRequestBuilder<
...
> extends RequestBuilder<SalesContractItem<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SalesContractItem<T>, T> {
    return new GetAllRequestBuilder<SalesContractItem<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SalesContractItem<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SalesContractItem<T>, T>(this.entityApi, {
  ...
  update(
    ...
    return new UpdateRequestBuilder<SalesContractItem<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SalesContractItem<T>, T>(
      this.entityApi,
      salesContractOrEntity instanceof SalesContractItem
