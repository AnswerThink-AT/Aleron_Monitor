 ...
 */
export class SalesContractTextRequestBuilder<
...
> extends RequestBuilder<SalesContractText<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SalesContractText<T>, T> {
    return new GetAllRequestBuilder<SalesContractText<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SalesContractText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SalesContractText<T>, T>(this.entityApi, {
  ...
  update(
    ...
    return new UpdateRequestBuilder<SalesContractText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SalesContractText<T>, T>(
      this.entityApi,
      salesContractOrEntity instanceof SalesContractText
