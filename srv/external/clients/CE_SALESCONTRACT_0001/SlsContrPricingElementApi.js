...
exports.SlsContrPricingElementApi = void 0;
/*
...
const SlsContrPricingElementRequestBuilder_1 = require("./SlsContrPricingElementRequestBuilder");
const Sap_Message_1 = require("./Sap_Message");
const odata_v4_1 = require("@sap-cloud-sdk/odata-v4");
class SlsContrPricingElementApi {
    constructor(deSerializers = odata_v4_1.defaultDeSerializers) {
        this.entityConstructor = SlsContrPricingElement_1.SlsContrPricingElement;
    ...
    requestBuilder() {
        return new SlsContrPricingElementRequestBuilder_1.SlsContrPricingElementRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(SlsContrPricingElement_1.SlsContrPricingElement, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', SlsContrPricingElement_1.SlsContrPricingElement)
            };
        }
        return this._schema;
    }
}
exports.SlsContrPricingElementApi = SlsContrPricingElementApi;
//# sourceMappingURL=SlsContrPricingElementApi.js.map