...
export declare class SalesContractTextApi<
...
> implements EntityApi<SalesContractText<DeSerializersT>, DeSerializersT>
{
  ...
  static _privateFactory<
    DeSerializersT extends DeSerializers = DefaultDeSerializers
  >(deSerializers?: DeSerializersT): SalesContractTextApi<DeSerializersT>;
  private navigationPropertyFields;
  _addNavigationProperties(
    linkedApis: [SalesContractApi<DeSerializersT>]
  ): this;
  entityConstructor: typeof SalesContractText;
  ...
  get fieldBuilder(): FieldBuilder<typeof SalesContractText, DeSerializersT>;
  private _schema?;
  get schema(): {
