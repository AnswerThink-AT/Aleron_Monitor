...
exports.SalesContractItemTextApi = void 0;
/*
...
const SalesContractItemTextRequestBuilder_1 = require("./SalesContractItemTextRequestBuilder");
const Sap_Message_1 = require("./Sap_Message");
const odata_v4_1 = require("@sap-cloud-sdk/odata-v4");
class SalesContractItemTextApi {
    constructor(deSerializers = odata_v4_1.defaultDeSerializers) {
        this.entityConstructor = SalesContractItemText_1.SalesContractItemText;
    ...
    requestBuilder() {
        return new SalesContractItemTextRequestBuilder_1.SalesContractItemTextRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(SalesContractItemText_1.SalesContractItemText, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', SalesContractItemText_1.SalesContractItemText)
            };
        }
        return this._schema;
    }
}
exports.SalesContractItemTextApi = SalesContractItemTextApi;
//# sourceMappingURL=SalesContractItemTextApi.js.map