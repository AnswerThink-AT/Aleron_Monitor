 ...
 */
export class SalesContractItemTextRequestBuilder<
...
> extends RequestBuilder<SalesContractItemText<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SalesContractItemText<T>, T> {
    return new GetAllRequestBuilder<SalesContractItemText<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SalesContractItemText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SalesContractItemText<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<SalesContractItemText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SalesContractItemText<T>, T>(
      this.entityApi,
      salesContractOrEntity instanceof SalesContractItemText
