 ...
 */
export class SalesContractRequestBuilder<
...
> extends RequestBuilder<SalesContract<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SalesContract<T>, T> {
    return new GetAllRequestBuilder<SalesContract<T>, T>(this.entityApi);
  }
  ...
  create(entity: SalesContract<T>): CreateRequestBuilder<SalesContract<T>, T> {
    return new CreateRequestBuilder<SalesContract<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SalesContract<T>, T>(this.entityApi, {
  ...
  update(entity: SalesContract<T>): UpdateRequestBuilder<SalesContract<T>, T> {
    return new UpdateRequestBuilder<SalesContract<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  ): DeleteRequestBuilder<SalesContract<T>, T> {
    return new DeleteRequestBuilder<SalesContract<T>, T>(
      this.entityApi,
      salesContractOrEntity instanceof SalesContract
