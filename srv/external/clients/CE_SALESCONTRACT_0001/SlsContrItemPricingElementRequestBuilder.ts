 ...
 */
export class SlsContrItemPricingElementRequestBuilder<
...
> extends RequestBuilder<SlsContrItemPricingElement<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SlsContrItemPricingElement<T>, T> {
    return new GetAllRequestBuilder<SlsContrItemPricingElement<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SlsContrItemPricingElement<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SlsContrItemPricingElement<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<SlsContrItemPricingElement<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SlsContrItemPricingElement<T>, T>(
      this.entityApi,
      salesContractOrEntity instanceof SlsContrItemPricingElement
