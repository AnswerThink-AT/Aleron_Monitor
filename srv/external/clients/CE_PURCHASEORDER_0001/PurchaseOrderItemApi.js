    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                ...
                /**
                 * Static representation of the {@link isToBeAcceptedAtOrigin} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                IS_TO_BE_ACCEPTED_AT_ORIGIN: fieldBuilder.buildEdmTypeField('IsToBeAcceptedAtOrigin', 'Edm.Boolean', false),
                /**
                ...
                /**
                 * Static representation of the {@link purContractItemForOverallLimit} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                PUR_CONTRACT_ITEM_FOR_OVERALL_LIMIT: fieldBuilder.buildEdmTypeField('PurContractItemForOverallLimit', 'Edm.String', false),
                /**
