/* checksum : b9eef27b038f8ad376a585864e0a8168 */
@cds.external : true
...
entity API_SALES_ORDER_SRV.A_SalesOrder {
  ...
  @sap.label : 'Alphanumeric Sales Order'
  YY1_AlphanumericSalesO_SDH : String(15);
  @sap.label : 'Ship To Party'
  YY1_ShipToParty_SDH : String(12);
  @sap.label : 'Custom Sales Order Type ( OLD)'
  YY1_CustomSalesOrder_SDH : String(4);
  @sap.label : 'Custom Billing Type ( OLD)'
  YY1_CustomBillingType_SDH : String(4);
...
entity API_SALES_ORDER_SRV.A_SalesOrderItem {
  ...
  @sap.label : 'Straight Time Markup'
  YY1_StrTimeMarkup_SD_SDI : String(10);
  @sap.label : 'Double Time Markup'
  YY1_DoubTimeMarkup_SD_SDI : String(10);
  @sap.label : 'Legacy Purchase Order'
  YY1_LegacyPurchase_SD_SDI : String(10);
  @sap.display.format : 'Date'
  @sap.label : 'Week End'
  YY1_WeekEnd_SD_SDI : Date;
  @sap.label : 'Custom URL'
  YY1_CustomURL_SDI : String(200);
  @sap.label : 'ExtensionUUID1'
  YY1_ExtensionUUID1_SDI : String(40);
  @sap.label : 'Cost Center'
  YY1_CostCenter_SD_SDI : String(15);
  @sap.label : 'EE SubGroup'
  YY1_EEGroup_SD_SDI : String(2);
  @sap.label : 'Duplicate Week'
  YY1_DuplicateWeek_SD_SDI : String(2);
  @sap.label : 'YY2_ACA_HRS'
  @sap.quickinfo : 'ACA Hours'
  YY1_ACA_HRS_SDI : Decimal(15, 2);
  @sap.label : 'Royality'
  YY1_Royality_SD_SDI : String(3);
  @sap.label : 'Commodity Code'
  YY1_CommodityCode_SD_SDI : String(15);
  @sap.label : 'ExtensionUUID2'
  YY1_ExtensionUUID2_SDI : String(40);
  @sap.label : 'Supplier Invoice Number'
  YY1_SupplierInvoice_SD_SDI : String(15);
  @sap.label : 'Invoice VAT txt'
  YY1_InvoiceVATtxt_SD_SDI : String(4);
  @sap.label : 'WN Work Order'
  YY1_WNWorkOrder_SD_SDI : String(10);
  @sap.label : 'Category Code'
  YY1_CategoryCode_SD_SDI : String(15);
  @sap.label : 'Over Time Markup'
  YY1_OverTimeMarkup_SD_SDI : String(10);
  @sap.label : 'YY3_ACA_HRS_PRICE'
  @sap.quickinfo : 'ACA Hours Price'
  YY1_ACA_HRS_PRICE_SDI : Decimal(15, 2);
  @sap.label : 'WN Invoice'
  YY1_WNInvoice_SD_SDI : String(15);
  @sap.label : 'Purchasing Doc'
  YY1_PurchasingDoc_SD_SDI : String(10);
  @sap.label : 'Custom Billing Type ( OLD)'
  YY1_CustomBillingType_SDI : String(4);
  @sap.label : 'YY1_ACA_RG_ONLY'
  @sap.quickinfo : 'Customer Condition Group 2'
  YY1_ACA_RG_ONLY_SDI : String(2);
...
) returns API_SALES_ORDER_SRV.FunctionResult;
