/* checksum : 2cc83677b5a71b78c5d6189c691e8cc8 */
@cds.external : true
type CE_PURCHASEORDER_0001.D_PurOrdGetOutputBinaryDataR {
...
entity CE_PURCHASEORDER_0001.PurchaseOrder {
  ...
  function GetOutputBinaryData(
    _it : $self not null
  ) returns CE_PURCHASEORDER_0001.D_PurOrdGetOutputBinaryDataR not null;
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrderItem {
  ...
  @Common.Label : 'SD Document'
  YY1_SDDocumentPD_PDI : String(10) not null;
  @Common.Label : 'Supplier Invoice Number'
  YY1_SupplierInvoiceNum_PDI : String(15) not null;
  @Common.Label : 'SD Document'
  YY1_SDDocument_PDI : Date;
  @Common.Label : 'Commodity Code'
  YY1_CommodityCode_PDI : String(15) not null;
  @Common.Label : 'Duplicate Week'
  YY1_DuplicateWeek_PDI : String(2) not null;
  @Common.Label : 'Legacy Purchase Order'
  YY1_LegacyPurchaseOrde_PDI : String(10) not null;
  @Common.Label : 'Category Code'
  YY1_CategoryCode_PDI : String(15) not null;
  @Common.Label : 'WN Work Order'
  YY1_WNWorkOrder_PDI : String(10) not null;
  @Common.Label : 'Week End'
  YY1_WeekEnd_PDI : Date;
  @Common.Label : 'Cost Center'
  YY1_CostCenter_PDI : String(15) not null;
  SAP__Messages : many CE_PURCHASEORDER_0001.SAP__Message not null;
  @Common.Composition : true
