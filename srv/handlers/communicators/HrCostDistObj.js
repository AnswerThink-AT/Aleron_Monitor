...
const LOG = cds.log('Monitor.Communicator-HrCostDistObj');
...
*/
  ...
  async getConnection() {
    const s4 = cds.connect.to('YY1_HRCOSTDISTRIBUTIONOBJ_CDS');
    return s4;
  }
  ...
  async executeQuery(query) {
    ...
    try {
      ...
      LOG._error && LOG.error(cds.i18n.messages.at('ERR_HrCostDistObj_1_QUERY', [err.message]));
      return err;
    }
  }
}

module.exports = HrCostDistObj;