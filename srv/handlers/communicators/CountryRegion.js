...
const LOG = cds.log('Monitor.Communicator-CountryRegion');
...
*/
  ...
  async _initConnection() {
    const s4 = await cds.connect.to('CE_CNSLDTNCOUNTRY_0001');
    return s4;
  }
  ...
  async executeQuery(query) {
    ...
    try {
      ...
      LOG._error && LOG.error(cds.i18n.messages.at('ERR_COUNTRYREGION_QUERY', [err.message]));
    }
  }
