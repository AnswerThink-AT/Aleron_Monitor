...
const LOG = cds.log('Monitor.Communicator-Product');
...
*/
  ...
  async getConnection() {
    const s4 = cds.connect.to('API_PRODUCT_SRV');
    return s4;
  }
  ...
  async executeQuery(query) {
    ...
    try {
      ...
      LOG._error && LOG.error(cds.i18n.messages.at('ERR_PRODUCT_QUERY', [err.message]));
      return err;
    }
  }
}
