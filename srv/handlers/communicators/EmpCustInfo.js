...
const LOG = cds.log('Monitor.Communicator-EmpCustInfo');
...
*/
  ...
  async getConnection() {
    const s4 = cds.connect.to('YY1_EMPLOYEE_CUSTOMER_INFO_CDS');
    return s4;
  }
  ...
  async executeQuery(query) {
    ...
    try {
      ...
      LOG._error && LOG.error(cds.i18n.messages.at('ERR_EMPCUSTINFOR_QUERY', [err.message]));
      return err;
    }
  }
}

module.exports = EmpCustInfo;