...
const LOG = cds.log('Monitor.Communicator-CompanyCode');
...
*/
  ...
  async getConnection() {
    const s4 = cds.connect.to('API_COMPANYCODE');
    return s4;
  }
  ...
  async executeQuery(query) {
    ...
    try {
      ...
      LOG._error && LOG.error(cds.i18n.messages.at('ERR_COMPANYCODE_QUERY', [err.message]));
    }
  }
}
