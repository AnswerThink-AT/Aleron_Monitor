...
const LOG = cds.log('Monitor.Communicator-SalesVCData_1');
...
*/
  ...
  async getConnection() {
    const s4 = cds.connect.to('YY1_SALESVCDATA_1_CDS');
    return s4;
  }
  ...
  async executeQuery(query) {
    ...
    try {
      ...
      LOG._error && LOG.error(cds.i18n.messages.at('ERR_SALESVCDATA_1_QUERY', [err.message]));
      return err;
    }
  }
}

module.exports = SalesVCData_1;